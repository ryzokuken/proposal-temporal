...
This method does the same thing as the `Temporal.PlainDateTime.prototype.until()` method, but reversed, and rounding takes place relative to `datetime` as an ending point instead of a starting point.
