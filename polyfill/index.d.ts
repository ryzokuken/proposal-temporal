export namespace Temporal {
  ...
  export interface CalendarProtocol {
    ...
    month(date: Temporal.PlainDate | Temporal.PlainDateTime | Temporal.PlainYearMonth | Temporal.PlainMonthDay | DateLike | string): number;
    ...
    daysInMonth?(date: Temporal.PlainDate | Temporal.PlainDateTime | Temporal.PlainYearMonth | DateLike | string): number;
    daysInYear?(date: Temporal.PlainDate | Temporal.PlainDateTime | Temporal.PlainYearMonth | DateLike | string): number;
    monthsInYear?(date: Temporal.PlainDate | Temporal.PlainDateTime | Temporal.PlainYearMonth | DateLike | string): number;
    inLeapYear?(date: Temporal.PlainDate | Temporal.PlainDateTime | Temporal.PlainYearMonth | DateLike | string): boolean;
    dateFromFields(
  ...
  export class Date implements DateFields {
    ...
    static compare(one: Temporal.PlainDate | DateLike | string, two: Temporal.PlainDate | DateLike | string): ComparisonResult;
  ...
  export class DateTime implements DateTimeFields {
    static from(item: Temporal.PlainDateTime | DateTimeLike | string, options?: AssignmentOptions): Temporal.PlainDateTime;
    static compare(
  ...
  export class MonthDay implements MonthDayFields {
    static from(item: Temporal.PlainMonthDay | MonthDayLike | string, options?: AssignmentOptions): Temporal.PlainMonthDay;
  ...
  export class Time implements TimeFields {
    ...
    static compare(one: Temporal.PlainTime | TimeLike | string, two: Temporal.PlainTime | TimeLike | string): ComparisonResult;
    constructor(
      hour?: number,
      minute?: number,
      second?: number,
  ...
  export interface TimeZoneProtocol {
    ...
    getInstantFor?(dateTime: Temporal.PlainDateTime | DateTimeLike | string, options?: ToInstantOptions): Temporal.Instant;
  ...
  export class YearMonth implements YearMonthFields {
    static from(item: Temporal.PlainYearMonth | YearMonthLike | string, options?: AssignmentOptions): Temporal.PlainYearMonth;
    static compare(
